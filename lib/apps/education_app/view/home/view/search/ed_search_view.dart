...
class EdSearchView extends StatelessWidget {
  const EdSearchView({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Search', style: AppTypography.black24w600),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Row(
              children: [
                Expanded(child: EdTextField(labelText: 'Search')),
                const SizedBox(width: 8),
                EdIconButton(onPressed: () {}),
              ],
            ),
            Expanded(
